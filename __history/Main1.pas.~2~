...
// Desc      : end
//==================================================================
procedure TMainFrm.N2Click(Sender: TObject);    // end
begin
  close;
end;
...
procedure TMainFrm.ZConnection1AfterConnect(Sender: TObject);
begin
...
// Desc      : Timer로 시간 표현
//==================================================================
Function TMainFrm.INI_Read(FileNames,Section,Key: string): string;
begin
  //Function INI_Read(FileNames,Section,Key: string): string;
end;
end.
